...
async def genStr(_, msg: Message):
    if msg.chat.id in Credentials.BANNED_USERS:
        await bot.send_message(
            chat_id=msg.chat.id,
            text="You are Banned. Contact My [Support Group](https://t.me/AnjalixSupportxGroup)",
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await bot.send_message(
                   chat_id=msg.chat.id,
                   text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/AnjalixSupportxGroup).",
                   parse_mode="markdown",
            ...
            await bot.send_message(
                chat_id=msg.chat.id,
                text="**Something Went Wrong. Contact My [Support Group](https://t.me/AnjalixSupportxGroup).**",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
